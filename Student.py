...
from simplerypt import firebase

firebase = firebase.FirebaseApplication("https://encryptedchat-61349-default-rtdb.firebaseio.com/", None)
...
def getData() :
    ...
    get_friends_data = firebase.get('/', your_firends_code)
